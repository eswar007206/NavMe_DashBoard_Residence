...
const routeMap: Record<string, string> = {
  ...
  ar_electronic_assets: "/electronic-assets",
  ar_complaints: "/complaints",
  ar_ropin_feedback: "/feedback",
};

const iconMap: Record<string, typeof MapPin> = {
  ar_ropin_pois: MapPin,
  ar_ropin_users: Users,
  ar_electronic_assets: Cpu,
  ar_complaints: MessageSquare,
  ar_ropin_feedback: Star,
};
